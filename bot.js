...
async function handlePostback(sender_psid, received_postback) {
   ...
   switch(payload) {
    ...
    // To Re-Activate The Bot takeControlApi
       ...
       case "PRICING": 
           let response0 = {"text": "في 200 جنيه تدفع مرة واحدة فقط لبرمجة البوت و تهيئته لاحتياجات صفحتك, والدفع بيتم بعد استلام البوت واختباره على صفحتك حتى تكون راضي عنه تماما."}
